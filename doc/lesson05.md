...
> Почему мы для InMemory не сдалели отдельного профиля?

Это классы, находящиеся в test, о них проект ничего не должен знать, для них сделали отдельный `mock.xml`
